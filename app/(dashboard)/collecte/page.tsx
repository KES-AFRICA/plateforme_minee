...
import { ErreursStats, Period } from "@/components/collecte/interface";
import {
  DonutChart,
  EquipIcon,
      ...
      <div className="rounded-2xl border border-[#D1DCF0] bg-white px-6 py-5">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => setFilterOpen(true)}
              className="flex items-center gap-2 rounded-xl border border-[#D1DCF0] bg-white px-4 py-2 text-[11px] font-semibold text-[#374151] transition hover:border-[#185FA5] hover:bg-[#F0F5FF] hover:text-[#185FA5]"
            >
            ...
            <button
              onClick={refresh}
              disabled={refreshing}
              className="flex items-center gap-2 rounded-xl border border-[#185FA5] bg-[#185FA5] px-4 py-2 text-[11px] font-bold text-white transition hover:bg-[#0C447C] disabled:opacity-60"
            >
              <RefreshCw
        ...
        <div className="flex items-center gap-3 border-b border-[#EEF1F7] px-5 py-4">
          <div>
            ...
            <p className="text-[10px] text-[#9CA3AF]">
              Pourcentages de collecte par direction régionale
            </p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="p-5">
            <p className="mb-4 text-[9px] font-bold uppercase tracking-widest text-[#9CA3AF]">
              Vue globale
            </p>
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <div className="flex items-center gap-1.5">
                  <div className="h-2.5 w-2.5 rounded-sm bg-[#1D9E75]" />
                  <span className="text-[11px] text-[#6B7280]">
                    Collectés {totalTaux}%
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <div className="h-2.5 w-2.5 rounded-sm bg-[#D1DCF0]" />
                  <span className="text-[11px] text-[#6B7280]">
                    Restants {100 - totalTaux}%
                  </span>
                </div>
              </div>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-0.5 text-[10px] text-[#9CA3AF]">
                      {d.postes_collectes.collectes} /{" "}
                      {d.postes_collectes.attendus || 0}
                    </p>
                  </div>
                );
              })}
