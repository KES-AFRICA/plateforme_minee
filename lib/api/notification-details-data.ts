...
export const mockNotifications: NotificationDetail[] = [
  {
    ...
    description: "Deux enregistrements identiques pour le transformateur DIKABO",
    ...
    sourceEquipment: {
      ...
      power: "630 kVA",
      tension: "15/0.4 kV",
      location: "Quartier Dikabo",
      status: "active",
    },
    targetEquipment: {
      id: "eq-2",
      code: "EQ-DIKABO-01-COPIE",
      name: "Transformateur DIKABO (copie)",
      type: "Transformateur",
      region: "Douala",
      zone: "Douala Ouest",
      departure: "BON.D11",
    ...
    action: { label: "Traiter", url: "/distribution/processing/duplicates/task-001" },
    metadata: { duplicateCount: 2, affectedRegion: "Douala", createdBy: "system" },
  },
  {
    id: "notif-002",
